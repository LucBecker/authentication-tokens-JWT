...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /**
     * Metodo para permitirmos ou restringir nosso suporte CORS. Podemos assim liberar
     * acessos a nossa API de várias fontes no nosso caso abaixo eu liberei acesso
